...
export function addWalls(game: Engine) {
  [
    {name: "left", x: 0, y: 0, width: 5, height: game.canvasHeight},
    {name: "top", x: 0, y: 0, width: game.canvasWidth, height: 5},
    {name: "bottom", x: 0, y: game.canvasHeight / 2, width: game.canvasWidth, height: 5},
    {name: "right", x: game.canvasWidth / 2, y: 0, width: 5, height: game.canvasHeight},
